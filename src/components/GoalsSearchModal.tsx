...
export const GoalsSearchModal = ({ onClose }: GoalsSearchModalProps) => {
  const [searchQuery, setSearchQuery] = useState('');

  const suggestedGoals = [
    { emoji: '🎓', text: 'College Tuition' },
    { emoji: '🏠', text: 'First Home Down Payment' },
    { emoji: '💍', text: 'Wedding Fund' },
    { emoji: '🌍', text: 'World Trip' },
    { emoji: '💻', text: 'New Laptop' },
    { emoji: '🚗', text: 'Car Down Payment' },
  ];
        ...
        <div className="p-4">
          <div className="relative">
            ...
            <input
              ...
              placeholder="Search for your saving goal..."
              className="w-full pl-12 pr-4 py-4 bg-gray-100 rounded-2xl text-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              autoFocus
            />
          </div>
        </div>
